...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://sheet.best/api/sheets/99f2a3c2-a7d7-4f89-80f2-2a991da99b5b',
        form).then((response) => {
            ...
            <div className="contact__container container grid">
                <div className="contact__content">
                    ...
                    <div className="contact__card">
                        ...
                        <p className="contact__card-data">shashwritescode@gmail.com</p>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <p className="contact__card-data">+91-91888-13209</p>
                    </div>
                </div>
